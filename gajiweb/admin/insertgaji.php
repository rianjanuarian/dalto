...
$query = mysqli_query($konek,"INSERT INTO tb_gaji (gaji_id, kary_id, kode_gaji, jam_lembur,sanksi, uang_lembur, total_gaji, bulan_transfer, tgl_transfer, jam_transfer) VALUES ('$gaji_id', '$kary_id', '$kode_gaji', '$jam_lembur','$sanksi', '$uang_lembur', '$total_gaji', '$bulan_transfer', '$tgl_transfer', '$jam_transfer')");
if ($query){

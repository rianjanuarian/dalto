...
$query = mysqli_query($konek,"INSERT INTO tb_gaji (gaji_id, kary_id, kode_gaji, jam_lembur, bonus, sanksi, uang_lembur, total_gaji,total_gajiusd, bulan_transfer, tgl_transfer, jam_transfer) VALUES ('$gaji_id', '$kary_id', '$kode_gaji', '$jam_lembur','$bonus', '$sanksi', '$uang_lembur', '$total_gaji', '$total_gajiusd', '$bulan_transfer', '$tgl_transfer', '$jam_transfer')");
if ($query){

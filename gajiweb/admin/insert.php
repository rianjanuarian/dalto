...
$query = mysqli_query($konek,"INSERT INTO karyawan (kary_id, kode_kar, nama_kar, alamat_kar, no_rek, gaji_utama, gol_kar) VALUES ('$kary_id', '$kode_kar', '$nama_kar', '$alamat_kar', '$no_rek', '$gaji_utama', '$gol_kar')");
if ($query){

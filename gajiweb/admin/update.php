...
$query = mysqli_query($konek,"UPDATE karyawan SET kode_kar='$kode_kar',nama_kar='$nama_kar', alamat_kar='$alamat_kar', no_rek='$no_rek', gaji_utama='$gaji_utama', gol_kar='$gol_kar'
